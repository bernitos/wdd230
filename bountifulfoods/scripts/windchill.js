const api_key = 'eca28685f631a2e2a2a95d8ba248ff08'
const cityId =5460459
const imgURL = 'https://openweathermap.org/img/w/'
const rnd = (n,d) => {
    return (Math.round(n*10**d)/10**d)
}
fetch('https://api.openweathermap.org/data/2.5/weather?id='+cityId+'&units=imperial&appid=eca28685f631a2e2a2a95d8ba248ff08')
    .then(res => {
        return res.json()
    })
    .then(jsonData => {
